...
data_department = {
    "角色": ["主辦單位", "入桌討論部會", "入桌討論部會", "入桌討論部會", "入桌討論部會", "入桌討論部會", "入桌討論部會", "入桌討論部會", "出席部會", "出席部會", "出席部會", "出席部會", "出席局處"],
    "機關單位": ["教育部青年發展署", "數位發展部", "教育部", "勞動部", "文化部", "衛生福利部", "法務部", "國家發展委員會", "內政部", "農業部", "原住民委員會", "個人資料保護委員會籌備處", "新北市青年局"],
    "對應組別": ["N/A", "D", "A", "B", "C", "E", "C", "E", "列席", "列席", "列席", "列席", "地方展板"]
}
